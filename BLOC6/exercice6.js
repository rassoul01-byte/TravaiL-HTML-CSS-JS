    ...
    function ajouterUtilisateur() {
      ...
      utilisateurs.push({ id: generId(), nom: nom, archive: false });
      sauvegarder();
    ...
    function sauvegarderModif() {
      ...
      if (nouveau === "") { alert("Le nom ne peut pas être vide !"); return; }
    ...
    function ajouterTache() {
      ...
      if (titre === "") { alert("Veuillez entrer une tâche !"); return; }
    ...
    function mettreAJourStats() {
      ...
      document.getElementById("stat-restantes").textContent = total - terminees;
    }
